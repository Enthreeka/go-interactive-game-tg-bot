...
Что нужно, чтобы принять участие? Всего 3 шага:
...
2. Перейти в бота @Tg_research_contest_bot и нажать «Старт»

3. Подписаться на официальную группу конкурса − https://t.me/tgresearh_contest (там же можно почитать отзывы о предыдущих розыгрышах)

Всё. Далее читаем каналы и ждём начала розыгрыша! Сам конкурс стартует 4 июля и продлится целых 10 дней – до 14 июля! 
